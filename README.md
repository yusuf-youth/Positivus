...
<ul>
  ...
  <li>
    <b>Semantics. </b>The project uses articles for cards, dialog for mobile menu, details for spoilers, <code>&altdetails&gt</code> for address information, and so on.
  </li>
